    ...
    <div>
      ...
      <div className="flex justify-center">
        <form className="flex flex-col  ">
          <textarea
            className=" m-10 p-2 rounded-lg shadow-xl text-center"
            placeholder="enter text you want to convert"
            cols="30"
            rows="7"
            value={text}
            onChange={(ev) => {
          ...
          ></textarea>
          <button
            className="p-2 bg-gray-700 w-1/2 mx-auto rounded-lg shadow-xl  text-white "
            onClick={handleClick}
          >
            Generate
          </button>
